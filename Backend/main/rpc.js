    ...
    try {
      ...
      rpcClient.on("ready", () => {
        ...
        rpcClient.setActivity({
          details: "Vie Tweaks - Tối ưu hóa trải nghiệm chơi game",
          state: `Đang chạy Vie Free Tweaks v${jsonData.version || "2"}`,
          buttons: [
             // keep this as parcoil incase of the domain going down
            { label: "✨Tải Xuống VIE TWEAKS", url: "https://discord.gg/VRAk33YzkE" },
            { label: "✨Tham Gia Discord", url: "https://discord.gg/VRAk33YzkE" },
          ],
          largeImageKey: "Vie Tweaks",
          largeImageText: "Vie Free Tweaks",
          instance: false,
        }).catch(err => {
